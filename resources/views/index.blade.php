...
<head>
    ...
    <title>StudyIT | Find your own journey</title>
</head>
<body>
    <!-- Sidebar Section -->
    <div class="container flex flex-row text-start bg-white text-textColor">
        <div class="sidebar flex flex-col bg-textColor w-52 h-auto p-4  text-primaryColor  border-x-slate-900  text-center">
            <div class="brand flex items-center ml-4">
                <div class="brand-logo">
                    <img  class= "size-6" src="{{'images/logo.png'}}" alt="">
                </div>
                <div class="brand-title mx-3">
                    <h1 class="text-2xl font-sans font-bold">StudyIT</h1>
                </div>
            </div>
            <div class="dashboard text-start mt-4">
                ...
                <div class="list-dashboard ">
                    <ul class="pt-3">
                        <div class="btn border-2 border-transparent py-3">
